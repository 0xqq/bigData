        ...
        <div class="table-view">
          <div class="table-inner">
            <el-table
              border  stripe
              size="mini"
              @row-click="(row)=>{if(this.auth['4217'])this.viewPM.rowClick(row);}"
              ...
              <el-table-column label="操作" fixed="right" width="240"
                               v-if="auth['4218']||auth['4220']||auth['4219']||auth['4221']" >
                <template slot-scope="scope">
                  <el-button type="text" size="mini"
                             v-if="auth['4218']"
                             @click="popTagWin(scope.row)" >资源标引</el-button>
                  <el-button type="text" size="mini"
                             v-if="auth['4220']"
                             v-show="scope.row.resourceStyle==='database'||!scope.row.resourceStyle"
                  ...
                  <el-button type="text" size="mini"
                             v-if="auth['4221']"
                             @click="popCodeWin(scope.row)" >资源编码</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
