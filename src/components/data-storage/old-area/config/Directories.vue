<script>
  ...
  export default {
    mixins:[ShareView],
    components:{  ContentTitle,DirectoriesMgerData,DirectoriesMger},
    data() {
    ...
    methods:{
       ...
       */
      fileBrows(value){
        this.$refs.targetFileBrows.open(value ,-1,this.auth["4214"]) ;
      }
    }
  }
</script>
...
<template>
  <div class="tj-t-view-inner" >
      ...
      <div class="table-view">
        <div class="table-inner">
          <el-table
            ...
            <el-table-column label="操作" fixed="right" width="85"  v-if="auth['4213']">
    ...
    <!--目录管理-->
    <!--文件选择-->
    <directories-mger-data  ref="targetFileBrows" ></directories-mger-data>
