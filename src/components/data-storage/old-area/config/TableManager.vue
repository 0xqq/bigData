      ...
      <v-group-iwt class="layout">
        ...
        <div class="field-table">
          <el-table border  stripe
            ...
            <el-table-column  prop="columnLength"  label="长度"  min-width="80px" >
              <template slot-scope="scope">
                ...
                <div style="width:100%;height:28px;position:relative;overflow: hidden;">
                  <div style="left:-2px;right:-40px;top:-1px;bottom:-2px;position:absolute;overflow: hidden;">
            ...
            <el-table-column label="操作" align="center" fixed="right" width="80"  v-if="auth['4210']">
              <template slot-scope="scope">
        ...
        <div class="table-view">
          <el-table border  stripe
            ...
            <el-table-column  prop="annotation" label="注释" ></el-table-column>
            ...
            <el-table-column label="操作" align="center" fixed="right" width="65"  v-if="auth['428']">
              <template slot-scope="scope">
