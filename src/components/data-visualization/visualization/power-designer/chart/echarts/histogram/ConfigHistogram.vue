<script>
  ...
  export default {
    ...
    data() {
      ...
      this.dynamicChartConfigPM = Inject.getClass(ConfigConstants.chartConfigMap.get(ChartEnum.ECHARTS_HISTOGRAM.id))
      return {
...
<template>
  <el-tabs type="border-card">
    ...
    <el-tab-pane label="柱形图堆叠" class="el-tab-pane">
      <el-card :body-style="{minHeight: '400px'}" header="堆叠关系构建">
        <echart-stack :settingsConfig="settings"></echart-stack>
      </el-card>
    </el-tab-pane>
