      ...
      <div class="search-form">
        <el-form ref="form"
          ...
          <tile-group-iwt :column="4" style="width:100%">
              ...
              <tile-item-iwt>
                <el-form-item label="任务名称:" prop="name"   class="form-item-pad">
              ...
              <tile-item-iwt>
                <el-form-item label="创建人:" prop="creator"   class="form-item-pad">
                  <el-input v-model="viewData.searchForm.creator"  ></el-input>
                </el-form-item>
              </tile-item-iwt>
        ...
        <div class="table-inner">
          <el-table  border
            ...
            <el-table-column label="操作" fixed="right" width="220px"
                             v-if="auth['51611']||auth['51610']||auth['5169']||auth['5167']||auth['5168']" >
              <template slot-scope="scope">
                <el-button type="text"
                           size="mini"
                           v-if="auth['51610'] && scope.row.status!=='1'"
                           :disabled="scope.row.canRun===false"
                           @click="viewPM.changeState(scope.row)" >启动</el-button>
                <el-button type="text"
                           size="mini"
                           v-if="auth['51611'] && scope.row.status==='1'"
