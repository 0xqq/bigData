...
export default class OtherAssetsMonitorAnalyzePM extends FormPmBase {
  ...
  constructor(name,id) {
    ...
    //初始化查询表单 aa
    this.initSearchForm( ) ;
    this.initSearchFormSW( ) ;
    this.initSearchFormDM( ) ;
   ...
   */
  queryList(){
    this.pagePM.queryList(this.data.searchForm) ;//查询*/
  }

  queryListSW(){
    this.pagePMSW.queryList(this.data.searchForm) ;//查询*/
  }

  queryListDM(){
    this.pagePMDM.queryList(this.data.searchForm) ;//查询*/
  }
  ...
  queryDetailList(item){
    this.detailPM.queryList({partition:3,ip:item},(datas)=>{
    } ) ;
  }
  queryDetailListSwName(item){
    this.detailPMSwName.queryList({partition:3,ip:item},(datas)=>{
    } ) ;
  }
