...
export default class OtherAssetsMonitorMangerPM extends FormPmBase {
  ...
  queryDetailList(item){
    this.detailPM.queryList({partition:2,ip:item},(datas)=>{
    } ) ;
  }
  queryDetailListSwName(item){
    this.detailPMSwName.queryList({partition:2,ip:item},(datas)=>{
    } ) ;
  }
