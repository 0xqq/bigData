<script>
  import OtherAssetsMonitorMangerPM from "./OtherAssetsMonitorMangerPM" ;
  import ContentTitle from "@/common/comps/normal/ContentTitle" ;
  import Inject from "@/common/model/Inject" ;
  import OtherAssetsMonitorMangerIpDetail from "./OtherAssetsMonitorMangerIpDetail";
  import OtherAssetsMonitorMangerOrgDetail from "./OtherAssetsMonitorMangerOrgDetail";


  export default {
    components:{ ContentTitle,OtherAssetsMonitorMangerIpDetail,OtherAssetsMonitorMangerOrgDetail},
    data() {
      this.viewPM = Inject.getClass(OtherAssetsMonitorMangerPM);
      return {
...
<template>
  <div class="container" style="margin-top: 40px">
    ...
    <!--IP查看详情-->
    <other-assets-monitor-manger-ip-detail></other-assets-monitor-manger-ip-detail>

    <!--部门查看详情-->
    <other-assets-monitor-manger-org-detail ref="maDetail"></other-assets-monitor-manger-org-detail>
