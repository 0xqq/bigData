<script>
  ...
  import OldAssetsMonitorIpDetail from "./OldAssetsMonitorIpDetail";
  import OldAssetsMonitorOrgDetail from "./OldAssetsMonitorOrgDetail";


  export default {
        components:{ ContentTitle,OldAssetsMonitorIpDetail,OldAssetsMonitorOrgDetail},
        data() {
...
<template>
  <div class="container" >
    ...
    <v-group-iwt class="layout">
      <!--title-->
      <content-title title="原始区" style="margin-bottom: 0px"></content-title>
      <!--tab也签切换-->
      <div class="nav-view">
        <div class="nav-inner">
    ...
    <!--IP查看详情-->
    <old-assets-monitor-ip-detail></old-assets-monitor-ip-detail>

    <!--部门查看详情-->
    <old-assets-monitor-org-detail ref="orgDetail"></old-assets-monitor-org-detail>
